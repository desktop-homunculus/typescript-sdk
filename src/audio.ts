...
export namespace audio {
    ...
    export namespace se {
         ...
         * ```
         */
        export const play = async (asset: string, options?: SeOptions) => {
    ...
    export namespace bgm {
         ...
         * ```
         */
        export const play = async (asset: string, options?: BgmPlayOptions) => {
         ...
         * ```
         */
        export const stop = async (options?: BgmStopOptions) => {
         ...
         * ```
         */
        export const update = async (options: BgmUpdateOptions) => {
         ...
         * ```
         */
        export const status = async (): Promise<BgmStatus> => {
