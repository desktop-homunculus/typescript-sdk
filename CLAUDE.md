...
TypeScript SDK (`hmcl-sdk`) for building mods and extensions for Desktop Homunculus — a cross-platform desktop mascot application built with the Bevy game engine. The SDK communicates with the Bevy application via HTTP REST API on `localhost:3100`.
